...
class ActifOut(BaseModel):
    ...
    plus_haut: float | None = None
    plus_bas: float | None = None
    cloture_veille: float | None = None
    haut_52s: float | None = None
    bas_52s: float | None = None
    quantite_echangee: float | None = None
    nb_titres: float | None = None
    bna: float | None = None
    dividende: float | None = None
    taux_distribution: float | None = None
    dette_nette: float | None = None
    ca: float | None = None
    nb_analystes: float | None = None
    date_cotation: str | None = None
    heure_cotation: str | None = None
